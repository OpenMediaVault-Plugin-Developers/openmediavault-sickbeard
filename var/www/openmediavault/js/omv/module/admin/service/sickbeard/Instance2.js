...
// require("js/omv/module/admin/service/sickbeard/Backup2.js")

Ext.define("OMV.module.admin.service.sickbeard.Instance2", {
    extend: "OMV.workspace.form.Panel",
    requires: [
        "OMV.data.Model",
        "OMV.data.Store",
        "OMV.module.admin.service.sickbeard.Backup2"
    ],
    ...
    getButtonItems: function() {
        ...
        items.push({
            ...
            handler: function() {
                ...
                if (proxy == true) {
                    var link = "http://" + location.hostname + "/sickbeard2/home/";
                } else {
            ...
            scope: this,
            handler: function() {
                Ext.create("OMV.module.admin.service.sickbeard.Backup2").show();
            } 
        }, {
    ...
    delSettings: function() {
        var me = this;
        var dir = this.getForm().findField("db-folder").getValue();
        var enable = this.getForm().findField("enable").getValue();
        if (enable = 1) {
             var command = "service sickbeard2 stop;rm -f " + dir + "/*.db;service sickbeard2 start";
...
OMV.WorkspaceManager.registerPanel({
    ...
    text      : _("Instance 2"),
    position  : 30,
    className : "OMV.module.admin.service.sickbeard.Instance2"
});
